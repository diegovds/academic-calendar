...
export type GetUsers200UserCoursesItemSemestersItemDisciplinesItemCreatedAt =
  | string
  | null

export type GetUsers200UserCoursesItemSemestersItemDisciplinesItemUpdatedAt =
  | string
  | null
